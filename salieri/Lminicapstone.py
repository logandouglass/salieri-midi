...
solo_prog = [(chords.major_triad("G"), 2), (chords.minor_triad("E"), 2), (chords.major_triad("C"), 2), (chords.major_triad("D"), 2)]
# solo_prog = [(chords.minor_triad("D"), 2), (chords.major_triad("Bb"), 2), (chords.major_triad("C"), 2), (chords.major_triad("A"), 2)] ## Highway Star Solo Segment
...
midi_file_out.write_Composition(f"{directory}/{compname}.mid", final_comp, bpm, loops)


## Print *something* so non-Logan users aren't like "wtf just happened?"
print(f"""
Your MIDI awaits in {directory}.
""")


# I should change the directory on my home copy.